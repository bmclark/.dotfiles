...
(custom-set-variables
 ...
 '(package-selected-packages
   '(visual-fill-column org-bullets magit counsel-projectile projectile all-the-icons counsel ivy-rich which-key rainbow-delimiters use-package ivy doom-modeline command-log-mode)))
(custom-set-faces
